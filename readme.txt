...
Determining Safety
The determineSafety() function takes the flow rate and categorizes it into different safety levels based on predefined thresholds:

Below 400 cfs: "Too low to raft, tubing"
400-799 cfs: "Low"
800-1499 cfs: "Medium"
...
Updating Indicators
The updateSafetyIndicators() function calls fetchRiverData(), then uses determineSafety() to get the safety level for the current flow rate. It then updates the visual indicators for both tubing and kayaking/rafting.
